document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayBreeds(breeds) {
      ...
      breeds.forEach(breed => {
        ...
        const dogShelterElement = document.createElement('p');
        dogShelterElement.classList.add('card-text');
        dogShelterElement.textContent = `Dog Shelter: ${breed.dog_shelter}`;
        ...
        breedBody.appendChild(dogShelterElement);
